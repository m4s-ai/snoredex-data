...
def _collect_g0(state: dict[str, Any]) -> dict[str, Any]:
    ...
    with guarded("G0", "loading the committed stores"):
        ...
        updates.update({"units": units, "finish_units": finish_units, "dataset": dataset, "cards": cards, "releases": releases, "bulbapedia_release_dates": bulbapedia_release_dates, "finish_analysis": finish_analysis})
    return updates

def _collect_g0b(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    with guarded("G0b", "indexing the finish store"):
        finish_units = state["finish_units"]
        ...
        updates.update({"finish_by_id": finish_by_id, "finish_by_key": finish_by_key})
    return updates

def _collect_g1(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    unknown_frontmatter_fields = None
    unit = None
    row = None
    readme = None
    prose_errors = None
    ...
    declaration_fields = None
    counts = None
    card = None
    allowed_processes = None
    allowed_levels = None
    ai_declaration_path = None
    ai_declaration = None
    with guarded("G1", "product view, pending semantics, public prose and AI declaration"):
        cards = state["cards"]
        finish_analysis = state["finish_analysis"]
        finish_by_id = state["finish_by_id"]
        finish_by_key = state["finish_by_key"]
        finish_units = state["finish_units"]
        releases = state["releases"]
        def _collect_g1_part1():
            nonlocal card, row, unit
            reachable_printings = {
                printing["printingId"]
                for card in cards
        ...
        def _collect_g1_part2():
            nonlocal card, counts, prose_errors, readme, row, unit
            blind_cells = []
            for row in releases:
        ...
        def _collect_g1_part3():
            nonlocal ai_declaration_path, line, unit
        ...
        def _collect_g1_part4():
            nonlocal ai_declaration, allowed_levels, allowed_processes, declaration_fields, declared_processes, frontmatter_match, global_level, line, unknown_frontmatter_fields
            ai_declaration = (
        ...
        _collect_g1_part4()
        _collect_g1_part5()
        updates.update({"readme": readme, "counts": counts})
    return updates

def _collect_g2(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    with guarded("G2", "documented build steps"):
        ...
        LIVE_STEPS = {
            ...
            "evidence_semantics.py", "source_adapters.py",
            "card_discovery.py",
        }
...
def _collect_g2b(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
...
def _collect_g2c(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    western_locale_faults = None
    western_locale_expectations = None
    total = None
    term = None
    svqp_rows = None
    svqp_ok = None
    stage_slices = None
    stable_keys = None
    spanish_locality_faults = None
    slice_accounting_faults = None
    rows = None
    row = None
    required_gap_terms = None
    request = None
    record_ids = None
    raw_path = None
    raw_hash_faults = None
    query_seed_faults = None
    pt_rows = None
    provenance_faults = None
    preservation_faults = None
    portuguese_gaps = None
    portuguese_faults = None
    pocket_rows = None
    pocket_faults = None
    name = None
    munchlax_faults = None
    missing_card_gaps = None
    locale = None
    line = None
    liga_rows = None
    language = None
    italian_slice_ok = None
    italian_rows = None
    italian_faults = None
    indonesian_minimum = None
    generic_spanish_sets = None
    gap_text = None
    forbidden_seeds = None
    field = None
    expected_tg10 = None
    expected_query_fields = None
    expected_liga_identity = None
    expected_italian_ids = None
    expected_card_buckets = None
    expected_bucket_counts = None
    discovered_by_slice = None
    count = None
    collapsed_locales = None
    card_stage = None
    card_source = None
    card_slices = None
    card_slice_faults = None
    card_run_root = None
    card_records_path = None
    card_records_bytes = None
    card_records = None
    card_raw_hash_faults = None
    card_provenance_faults = None
    card_preservation_faults = None
    card_manifest = None
    card_contract = None
    card_bucket_counts = None
    card_adapters = None
    asia_slice_faults = None
    asia_slice_expectations = None
    adapter_stage = None
    adapter_records_bytes = None
    adapter_records = None
    adapter_manifest = None
    adapter_contract = None
    adapter_buckets = None
    actual = None
    with guarded("G2c", "source-first discovery staging"):
        def _collect_g2c_part1():
            nonlocal actual, adapter_buckets, adapter_contract, adapter_manifest, adapter_records, adapter_records_bytes, adapter_stage, expected_bucket_counts, line, raw_hash_faults, raw_path, request, row
        ...
        def _collect_g2c_part2():
            nonlocal field, forbidden_seeds, record_ids, row, slice_accounting_faults, stable_keys
        ...
        def _collect_g2c_part3():
            nonlocal count, name, provenance_faults, row
            check(
                "N12",
        ...
        def _collect_g2c_part4():
            nonlocal generic_spanish_sets, preservation_faults, row
            preservation_faults = [
        ...
        def _collect_g2c_part5():
            nonlocal collapsed_locales, gap_text, required_gap_terms, row, spanish_locality_faults
        ...
        def _collect_g2c_part6():
            nonlocal card_contract, card_manifest, card_records_path, card_run_root, card_stage, row, term
        ...
        def _collect_g2c_part7():
            nonlocal actual, card_bucket_counts, card_raw_hash_faults, card_records, card_records_bytes, discovered_by_slice, expected_card_buckets, line, raw_path, request, row
        ...
        def _collect_g2c_part8():
            nonlocal card_adapters, card_slice_faults, card_slices, expected_query_fields, field, row
            card_slice_faults = [
        ...
        def _collect_g2c_part9():
            nonlocal query_seed_faults, request
            query_seed_faults = [
        ...
        def _collect_g2c_part10():
            nonlocal count, name, row
        ...
        def _collect_g2c_part11():
            nonlocal card_preservation_faults, card_provenance_faults, row, svqp_rows
        ...
        def _collect_g2c_part13():
            nonlocal western_locale_faults
            western_locale_faults = []

        def _collect_g2c_part14():
            nonlocal language, locale, row, rows, total
        ...
        def _collect_g2c_part15():
            nonlocal expected_tg10, row
            spanish_rows = [
                row
        ...
        def _collect_g2c_part16():
            nonlocal locale, portuguese_faults, pt_rows, row
            tg10_rows = {
        ...
        def _collect_g2c_part17():
            nonlocal expected_liga_identity, liga_rows, row
            if (
                len(pt_rows) != 26
        ...
        def _collect_g2c_part18():
            nonlocal portuguese_gaps, row
            if (
        ...
        def _collect_g2c_part19():
            nonlocal expected_italian_ids, italian_faults, italian_rows, row
            if (
        ...
        def _collect_g2c_part20():
            nonlocal asia_slice_expectations, asia_slice_faults, italian_slice_ok, row, stage_slices
            italian_gap = next(
        ...
        def _collect_g2c_part21():
            nonlocal indonesian_minimum, language, locale, row, rows, total
        ...
        def _collect_g2c_part22():
            nonlocal card_source, missing_card_gaps, row, term
...
def _collect_g3(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    with guarded("G3", "image formats"):
        ...
        updates.update({"image_format": image_format})
    return updates

def _collect_g4(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    weak_single = None
    u = None
    single_source_units = None
    single_source = None
    settles_absence = None
    resolved_units = None
    registry = None
    provider_by_id = None
    provider = None
    ...
    figure_docs = None
    drift = None
    documented_figures = None
    corroborated_units = None
    card = None
    by_provider = None
    attestation_only = None
    absence_backing = None
    with guarded("G4", "evidence identity and documented policy"):
        cards = state["cards"]
        units = state["units"]
        def _collect_g4_part1():
            nonlocal provider_by_id, registry, resolved_units, u
        ...
        def _collect_g4_part2():
            nonlocal attestation_only, by_provider, figure_docs, policy_docs, single_source, u
        ...
        def _collect_g4_part3():
            nonlocal corroborated_units, drift, figure_drift, single_source_units, u, weak_single
        ...
        def _collect_g4_part4():
            nonlocal absence_backing, documented_figures, drift, provider, settles_absence
        ...
        _collect_g4_part6()
        _collect_g4_part7()
        updates.update({"resolved_units": resolved_units, "by_provider": by_provider, "single_source": single_source, "single_source_units": single_source_units, "weak_single": weak_single, "corroborated_units": corroborated_units})
    return updates

def _collect_g5(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    with guarded("G5", "finish store consistency"):
        by_provider = state["by_provider"]
        corroborated_units = state["corroborated_units"]
        finish_units = state["finish_units"]
        resolved_units = state["resolved_units"]
        single_source = state["single_source"]
        single_source_units = state["single_source_units"]
        units = state["units"]
        weak_single = state["weak_single"]
        # --------------------------------------------------------------------------- #
...
def _collect_g6(state: dict[str, Any]) -> dict[str, Any]:
    ...
    with guarded("G6", "specimen records"):
        ...
        def _collect_g6_part4():
            nonlocal entry, rarity_catalogue, u
        ...
        def _collect_g6_part5():
            nonlocal SPECIMEN_EDITIONS, SPECIMEN_FINISHES, SPECIMEN_MARKING_ROLES, entry, malformed
            unquoted_finish = [
...
def _collect_g7(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    unflagged = None
    row = None
    release_rows_by_code = None
    release_row = None
    precision = None
    many_languages = None
    key = None
    ...
    count = None
    c = None
    bulbapedia_projection_drift = None
    bulbapedia_codes = None
    with guarded("G7", "dataset identity and typed fields"):
        bulbapedia_release_dates = state["bulbapedia_release_dates"]
        cards = state["cards"]
        finish_units = state["finish_units"]
        readme = state["readme"]
        releases = state["releases"]
        units = state["units"]
        def _collect_g7_part1():
            nonlocal c, many_languages
        ...
        def _collect_g7_part2():
            nonlocal c, key, unflagged
        ...
        def _collect_g7_part3():
            nonlocal c, count, key, row
            check(
                "F4.1",
        ...
        def _collect_g7_part4():
            nonlocal has_sort_key, precision, row
        ...
        def _collect_g7_part5():
            nonlocal bulbapedia_codes, bulbapedia_projection_drift, count, release_row, release_rows_by_code
            check(
                "F7.2",
        ...
        def _collect_g7_part6():
            nonlocal release_row
...
def _collect_g8(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    tracked = None
    sensitive_matches = None
    personal_commit_emails = None
    path = None
    non_email_pattern = None
    non_email_markers = None
    identity_fields = None
    history_shallow = None
    history_scanned = None
    history_hits = None
    email_pattern = None
    email_local_chars = None
    decisions = None
    decision_keys = None
    data = None
    with guarded("G8", "publication readiness"):
        def _collect_g8_part1():
            nonlocal email_local_chars, email_pattern, non_email_markers, non_email_pattern, path
            required_licences = {
        ...
        def _collect_g8_part2():
            nonlocal sensitive_matches
        ...
        def _collect_g8_part3():
            nonlocal data, path, tracked
            scanned, hits = 0, []
        ...
        def _collect_g8_part4():
            nonlocal data, decision_keys, decisions, history_hits, history_scanned, history_shallow, path
        ...
        def _collect_g8_part5():
            nonlocal identity_fields, personal_commit_emails
            check(
                "P5",
        ...
        def _collect_g8_part6():
            nonlocal personal_commit_emails
        ...
        _collect_g8_part5()
        _collect_g8_part6()
        updates.update({"tracked": tracked})
    return updates

def _collect_g9(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
...
def _collect_g10(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    registry_path = None
    marking_text = None
    with guarded("G10", "source registry"):
        def _collect_g10_part1():
            nonlocal registry_path
            registry_path = ROOT / "verification" / "source_registry.json"

        def _collect_g10_part2():
            declared = None
            missing_capability_files = None
            provider = None
            registry = None
            row = None
            if registry_path.exists():
                def _collect_g10_part2_if_part1():
                    nonlocal declared, provider, registry, row
                    registry = load("verification/source_registry.json")
                ...
                def _collect_g10_part2_if_part2():
                    nonlocal missing_capability_files, provider
                    missing_attribution = [
                        provider["providerId"]
                        for provider in registry["providers"]
                ...
                def _collect_g10_part2_if_part3():
                    nonlocal provider, row
                    capability_graph = None
                    graph_surfaces = None
                    graph_edges = None
                    if not missing_capability_files:
                        def _collect_g10_part2_if_part3_s5():
                            nonlocal capability_graph, graph_surfaces, graph_edges
                        ...
                        def _collect_g10_part2_if_part3_s6():
                            nonlocal capability_graph, graph_surfaces, graph_edges
                            observations = {
                        ...
                        _collect_g10_part2_if_part3_s6()
                    else:
                        check(
                ...
                _collect_g10_part2_if_part1()
                _collect_g10_part2_if_part2()
                _collect_g10_part2_if_part3()
            else:
        ...
        def _collect_g10_part3():
            nonlocal marking_text
        ...
        _collect_g10_part2()
        _collect_g10_part3()
        updates.update({"marking_text": marking_text})
    return updates

def _collect_g11(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    checklist_path = None
    with guarded("G11", "checklist export"):
        cards = state["cards"]
        marking_text = state["marking_text"]
        def _collect_g11_part1():
            nonlocal checklist_path
            checklist_path = ROOT / "analysis_checklist.json"

        def _collect_g11_part2():
            balls = None
            checklist_doc = None
            exs = None
            i = None
            ...
            if checklist_path.exists():
                def _collect_g11_part2_if_part1():
                    nonlocal checklist_doc, i, items, language
                ...
                def _collect_g11_part2_if_part2():
                    nonlocal i
                    code_card_sets = {
                ...
                def _collect_g11_part2_if_part3():
                    nonlocal i
                ...
                def _collect_g11_part2_if_part4():
                    nonlocal balls, i
                    df_reverse = [
                        i for i in items
                ...
                def _collect_g11_part2_if_part5():
                    nonlocal i, jumbo, jumbo_pairs, o
                ...
                def _collect_g11_part2_if_part6():
                    nonlocal i, o
                ...
                def _collect_g11_part2_if_part7():
                    nonlocal exs, i
                    xsv2a_ja = [
                        i for i in items
                ...
                def _collect_g11_part2_if_part8():
                    nonlocal i
                ...
                _collect_g11_part2_if_part1()
                _collect_g11_part2_if_part2()
                _collect_g11_part2_if_part3()
                _collect_g11_part2_if_part4()
                _collect_g11_part2_if_part5()
                _collect_g11_part2_if_part6()
                _collect_g11_part2_if_part7()
                _collect_g11_part2_if_part8()
            else:
...
def _collect_g12(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    form_path = None
    with guarded("G12", "correction issue form"):
        finish_units = state["finish_units"]
        def _collect_g12_part1():
            nonlocal form_path
            form_path = ROOT / ".github" / "ISSUE_TEMPLATE" / "printing-correction.yml"

        def _collect_g12_part2():
            element = None
            error = None
            form = None
            form_body = None
            form_doc = None
            schema_problems = None
            u = None
            if form_path.exists():
                def _collect_g12_part2_if_part1():
                    nonlocal element, error, form, form_doc, schema_problems
                ...
                def _collect_g12_part2_if_part2():
                    nonlocal error, form_body, u
                    try:
                        sys.path.insert(0, str(ROOT / "scripts"))
                ...
                def _collect_g12_part2_if_part3():
                    nonlocal element
                    evidence_fields = [
                ...
                def _collect_g12_part2_if_part4():
                    nonlocal element
                ...
                def _collect_g12_part2_if_part5():
                    nonlocal u
                ...
                _collect_g12_part2_if_part1()
                _collect_g12_part2_if_part2()
                _collect_g12_part2_if_part3()
                _collect_g12_part2_if_part4()
                _collect_g12_part2_if_part5()
            else:
...
def _collect_g13(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
...
def _collect_g14(state: dict[str, Any]) -> dict[str, Any]:
    updates: dict[str, Any] = {}
    rel = None
    line = None
    docs = None
    ...
    with guarded("G14", "documentation roles and load stages"):
        def _collect_g14_part1():
            nonlocal doc, docs, line, rel
        ...
        def _collect_g14_part2():
            nonlocal doc, line, rel
...
def collect() -> None:
    ...
    state.update(_collect_g1(state))
    state.update(_collect_g2(state))
    state.update(_collect_g2b(state))
    state.update(_collect_g2c(state))
    state.update(_collect_g3(state))
    state.update(_collect_g4(state))
    state.update(_collect_g5(state))
    state.update(_collect_g6(state))
    state.update(_collect_g7(state))
    state.update(_collect_g8(state))
    state.update(_collect_g9(state))
    state.update(_collect_g10(state))
    state.update(_collect_g11(state))
    state.update(_collect_g12(state))
    state.update(_collect_g13(state))
    state.update(_collect_g14(state))
