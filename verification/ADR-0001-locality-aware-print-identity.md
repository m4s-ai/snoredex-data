...
materialized in `snoredex.sqlite`'s `graph_*` tables; legacy compatibility projections remain
available while applications migrate. The machine-readable contract is
