...
Snapshot date: **2026-08-11** · SQLite schema: **1.2.0** · source fingerprint:
`1a3003ac0dda1b13…`
...
| App language statuses | 606 exists · 28 needs-evidence · 58 not-printed · 27 disputed (58 owner-adjudicated) |
| Established product-edition rows | 630 (58 absent-language and 55 unverified-language projections suppressed) |
| Finish units / logical printings | 637 / 693 |
| Current-known physical checklist | 814 (655 documented · 159 unresolved placeholders) |
...
The database preserves all **634** raw
`repository_verdict='confirmed'` rows. Only **606** have evidence whose
granularity may establish the exact card. The remaining **28** are
...
application decision separately. **58** rows are linked to
...
other single provider. The remaining **27** rows stay
...
- Edition rows exist only for positively established product languages. The source projection's
  58 rows for explicitly absent languages and
  55 rows for unverified languages are recorded as quality
