...
Snapshot date: **2026-09-08** · SQLite schema: **1.7.0** · source fingerprint:
`a2f2bbe3aa08af40…`
...
| Finish units / logical printings | 637 / 843 |
| Current-known physical checklist | 889 (813 documented · 76 unresolved placeholders) |
| Collector compatibility projection | 702 current-known · 111 finish candidates · 76 research placeholders (187 research rows) |
...
| Authoritative graph entities / typed edges | 7895 / 11795 |
| Graph migration inputs with dispositions | 2755 (432 raw set records) |
