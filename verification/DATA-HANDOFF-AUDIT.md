...
Snapshot date: **2026-09-21** · SQLite schema: **1.7.0** · source fingerprint:
`8a95b0dfa2effd52…`
...
| Finish units / logical printings | 637 / 857 |
| Current-known physical checklist | 899 (830 documented · 69 unresolved placeholders) |
| Collector compatibility projection | 717 current-known · 113 finish candidates · 69 research placeholders (182 research rows) |
...
| Authoritative graph entities / typed edges | 8186 / 12177 |
| Graph migration inputs with dispositions | 2861 (475 raw set records) |
