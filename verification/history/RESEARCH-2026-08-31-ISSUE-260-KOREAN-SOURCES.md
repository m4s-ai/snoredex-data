...
| U0127 | `m2a 136/193`, Hop's Snorlax | [Bunjang listing](https://globalbunjang.com/product/423487583) and Korean card photo (`SPEC-0436`); exact physical specimen |
| U0233 | `sv5a 051/066 U` | [Pokémon Korea](https://pokemoncard.co.kr/cards/detail/BS2024007051) and retained seller photo (`SPEC-0441`) |
| U0257 | `m3 062/080 C` | Retained Korean seller photo (`SPEC-0443`); [Collectory record](https://collectory.cc/cards/b6401ed6-1c9a-4703-9b55-762ac6e6d33e) corroborates identity |
...
| U0541 | `XY10 057/078 C` | [Awakening Psychic King list](https://dark.namu.moe/w/%EC%B4%88%EB%8A%A5%EB%A0%A5%EC%9D%98%20%EC%A0%9C%EC%99%95) and retained Korean seller photo (`SPEC-0457`) |
...
| U0561 | `XY2 066/080 U` | [Pokémon Korea](https://pokemoncard.co.kr/cards/detail/BS2014002066) and retained Cardmarket seller photograph (`SPEC-0411`) |
| U0579 | `BW7 055/070 U`, 잠만보 플라스마단 | [Pokémon Korea](https://pokemoncard.co.kr/cards/detail/BS2013001055) and retained Korean seller photo (`SPEC-0442`) |
| U0586 | Beginning Set row is `026/039`; Collectory also has `026/036` under a Chespin's Evolution product | [Kalos Starter Set article](https://bulbapedia.bulbagarden.net/wiki/Kalos_Starter_Set_(TCG)) and [Collectory record](https://collectory.cc/cards/f0ae72d3-a5da-4535-bd33-585d2938cd6a); retained Korean render (`SPEC-0461`) supports the `026/036` branch, taxonomy conflict remains |
| U0590 | `mC 568/742` | [Collectory KR record](https://collectory.cc/cards/f7c4636f-8030-40a7-86d6-994a0bc3283c) and retained Korean photo (`SPEC-0459`) |
...
| U0610 | `sA 010/023` | [Collectory KR record](https://collectory.cc/cards/481d9b00-6a36-4954-bb67-c5b411d5fe39) and retained Korean render (`SPEC-0462`); fixed-deck identity positive |
| U0623 | Korean DP promo is `006 PROMO`, not Japanese `DP-P 127` | [Korean promo list](https://www.namu.moe/w/%ED%8F%AC%EC%BC%93%EB%AA%AC%20%EC%B9%B4%EB%93%9C%20%EA%B2%8C%EC%9E%84/%ED%95%9C%EA%B5%AD%20%ED%94%84%EB%A1%9C%EB%AA%A8%20%EC%B9%B4%EB%93%9C%20%EC%9D%BC%EB%9E%8C) and retained Korean promo photo (`SPEC-0440`) |
...
| U0648 | Korean product row is `svI 046/066` | [Battle Academy list](https://d.namu.moe/w/%EC%8A%A4%EC%B9%BC%EB%A0%9B%26%EB%B0%94%EC%9D%B4%EC%98%AC%EB%A0%9B%20%E3%80%8C%EB%B0%B0%ED%8B%80%20%EC%95%84%EC%B9%B4%EB%8D%B0%EB%AF%B8%E3%80%8D) and [Collectory KR record](https://collectory.cc/cards/73c55006-427b-45ae-9a58-f7facd855820); retained Korean render (`SPEC-0463`); legacy `svIba` label needs normalization |
| U0677 | `svLN 010/022` | Retained Korean seller photo (`SPEC-0438`); identity positive |
...
| U0683 | `mC 567/742` | [Collectory KR record](https://collectory.cc/cards/a504064b-e9ee-44ee-9e6e-329a3b81974d) and retained Korean photo (`SPEC-0458`) |
| U0763 | `mC 569/742`, Hop's Snorlax | [Collectory KR record](https://collectory.cc/cards/5c9ad620-27b1-4a36-a7fb-1d50394b1fec) and retained Korean photo (`SPEC-0460`) |
...
| U0780 | Korean 151 `143/165` Poké Ball mirror | `SPEC-0061` (owner photograph; repeated Poké Ball silhouettes directly visible) and [151 set rule](https://bulbapedia.bulbagarden.net/wiki/151_(TCG)); positive physical specimen, no further photo task |
| U0785 | `xm2a 136/193` Poké Ball mirror | [Cardmarket seller photo](https://www.cardmarket.com/en/Pokemon/Products/Singles/MEGA-Dream-ex-Additionals/Hops-Snorlax-V2-xm2a136), retained as `SPEC-0410`; exact physical specimen |
| U0790 | `xm2a 136/193` Colorless-Energy mirror | [Bunjang seller photo](https://globalbunjang.com/product/420832203), retained as `SPEC-0437`; exact physical specimen |
...
1. Obtain a Korean card-face photograph for U0049/U0103 and for the Korean 151 Master Ball mirror
   U0775. `SPEC-0061` positively closes U0780's Poké Ball mirror; the 151 rule alone does not
   assign a particular card to a particular pattern.
