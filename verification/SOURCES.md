...
Every sourced claim in this project maps to exactly one provider below. 6252 claims are attributed across 1614 distinct sources (1607 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 133 | 561 | language, identity, finish, edition |
