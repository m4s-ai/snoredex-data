...
Every sourced claim in this project maps to exactly one provider below. 6295 claims are attributed across 1633 distinct sources (1626 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 65 | 775 | language, identity, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 179 | 674 | language, identity, finish, edition |
