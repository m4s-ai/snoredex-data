...
Every sourced claim in this project maps to exactly one provider below. 6269 claims are attributed across 1632 distinct sources (1625 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 64 | 749 | language, identity, finish, edition |
