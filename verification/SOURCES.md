...
Every sourced claim in this project maps to exactly one provider below. 6202 claims are attributed across 1629 distinct sources (1622 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 63 | 729 | language, identity, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 177 | 656 | language, identity, finish, edition |
