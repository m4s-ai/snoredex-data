...
Every sourced claim in this project maps to exactly one provider below. 2789 claims are attributed across 889 distinct sources (882 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 2 | no | 88 | 689 | language, edition, date, finish |
