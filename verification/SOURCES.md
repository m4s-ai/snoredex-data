...
Every sourced claim in this project maps to exactly one provider below. 6187 claims are attributed across 1606 distinct sources (1599 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 129 | 549 | language, identity, finish, edition |
