...
Every sourced claim in this project maps to exactly one provider below. 6276 claims are attributed across 1619 distinct sources (1612 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 204 | 732 | language, card-existence, local-set-identifier, rarity, date |
