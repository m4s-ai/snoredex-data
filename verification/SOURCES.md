...
Every sourced claim in this project maps to exactly one provider below. 3046 claims are attributed across 919 distinct sources (912 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 4 | 16 | language, finish, edition |
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | yes | 28 | 197 | language, finish, product |
| **52poke (Wiki)** | collector-database | 2 | no | 1 | 1 | language, artist, edition, finish |
| **Bulbapedia** | fan-wiki | 2 | no | 86 | 672 | language, edition, date, finish |
...
| **Collection owner attestation** | non-url-evidence | 2 | no | 1 | 39 | language, finish, edition |
...
| **TCGCSV (TCGplayer product data)** | marketplace-catalogue | 3 | no | 7 | 94 | finish, product |
| **koreanpokemoncards.com** | collector-database | 3 | no | 0 | 0 | language, finish |
| **pokumon.com** | collector-database | 3 | no | 2 | 3 | language |
| **Cardmarket** | marketplace-catalogue | 5 | no | 396 | 944 | product, image, finish |
