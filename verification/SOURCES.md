...
Every sourced claim in this project maps to exactly one provider below. 5064 claims are attributed across 1534 distinct sources (1527 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 51 | 349 | language, identity, finish, edition |
| **Play! Pokémon rewards gallery** | official-publisher | 1 | positive only | 1 | 32 | finish, product |
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 192 | 632 | language |
| **Pokémon Card official database (Japan)** | official-publisher | 1 | positive only | 37 | 83 | language, artist, date |
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 93 | 210 | language, product |
...
| **52poke (Wiki)** | collector-database | 2 | positive only | 13 | 31 | language, artist, edition, finish |
...
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | positive only | 8 | 18 | language, identity, finish, edition |
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 111 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 119 | 403 | language, identity, finish, edition |
...
| **Retailer and specialist card listings** | retail-listing | 3 | positive only | 28 | 81 | finish, product, language |
...
| **pokumon.com** | collector-database | 3 | positive only | 10 | 30 | language, finish |
| **Cardmarket** | marketplace-catalogue | 5 | positive only | 348 | 871 | product, image, finish |
