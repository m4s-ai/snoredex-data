...
Every sourced claim in this project maps to exactly one provider below. 2873 claims are attributed across 924 distinct sources (917 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 7 | 19 | language, finish, edition |
...
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | no | 5 | 6 | language, finish, edition |
