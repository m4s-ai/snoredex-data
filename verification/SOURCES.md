...
Every sourced claim in this project maps to exactly one provider below. 2888 claims are attributed across 921 distinct sources (914 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 5 | 34 | language, finish, edition |
...
| **Cardmarket** | marketplace-catalogue | 5 | no | 396 | 920 | product, image, finish |
