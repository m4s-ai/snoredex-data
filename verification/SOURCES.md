...
Every sourced claim in this project maps to exactly one provider below. 3695 claims are attributed across 1269 distinct sources (1262 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 29 | 75 | language, identity, finish, edition |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 70 | language, finish, edition |
...
| **Cardmarket** | marketplace-catalogue | 5 | positive only | 349 | 865 | product, image, finish |
