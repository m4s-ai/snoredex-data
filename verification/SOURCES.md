...
Every sourced claim in this project maps to exactly one provider below. 3648 claims are attributed across 1249 distinct sources (1242 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 29 | 72 | language, identity, finish, edition |
...
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 92 | 135 | language, product |
...
| **Bulbapedia** | fan-wiki | 2 | positive only | 80 | 631 | language, edition, date, finish |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 65 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 71 | 128 | language, identity, finish, edition |
| **TCGdex** | open-database | 2 | positive only | 308 | 745 | language, finish |
| **pokemontcg.io** | open-database | 2 | positive only | 1 | 123 | artist, date |
| **Collectory** | collector-database | 3 | positive only | 7 | 14 | identity, rarity |
...
| **Retailer and specialist card listings** | retail-listing | 3 | positive only | 7 | 34 | finish, product, language |
