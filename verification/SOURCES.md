...
Every sourced claim in this project maps to exactly one provider below. 6212 claims are attributed across 1629 distinct sources (1622 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 63 | 732 | language, identity, finish, edition |
...
| **Bulbapedia** | fan-wiki | 2 | positive only | 89 | 650 | language, edition, date, finish |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 156 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 177 | 665 | language, identity, finish, edition |
