...
Every sourced claim in this project maps to exactly one provider below. 3556 claims are attributed across 1186 distinct sources (1179 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 68 | 120 | language, identity, finish, edition |
