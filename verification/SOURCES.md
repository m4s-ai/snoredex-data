...
Every sourced claim in this project maps to exactly one provider below. 6029 claims are attributed across 1591 distinct sources (1584 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 61 | 697 | language, identity, finish, edition |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 134 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 164 | 610 | language, identity, finish, edition |
