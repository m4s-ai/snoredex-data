...
Every sourced claim in this project maps to exactly one provider below. 2777 claims are attributed across 882 distinct sources (875 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 3 | no | 90 | 692 | language, edition, date, finish |
