...
Every sourced claim in this project maps to exactly one provider below. 6262 claims are attributed across 1591 distinct sources (1584 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 61 | 817 | language, identity, finish, edition |
| **Play! Pokémon rewards gallery** | official-publisher | 1 | positive only | 1 | 32 | finish, product |
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 192 | 704 | language |
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | positive only | 123 | 427 | language, finish, product |
| **52poke (Wiki)** | collector-database | 2 | positive only | 13 | 33 | language, artist, edition, finish |
| **Bulbapedia** | fan-wiki | 2 | positive only | 89 | 653 | language, edition, date, finish |
| **CGC certification and registry** | grading-registry | 2 | positive only | 0 | 0 | finish, language |
| **Cardmarket exact product image** | marketplace-photo | 2 | positive only | 48 | 169 | language, identity, finish, edition, image |
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | positive only | 8 | 38 | language, identity, finish, edition |
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 157 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 164 | 747 | language, identity, finish, edition |
...
| **Retailer and specialist card listings** | retail-listing | 3 | positive only | 28 | 95 | finish, product, language |
