...
Every sourced claim in this project maps to exactly one provider below. 6267 claims are attributed across 1616 distinct sources (1609 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 202 | 729 | language, date |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 135 | 569 | language, identity, finish, edition |
