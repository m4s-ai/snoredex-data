...
Every sourced claim in this project maps to exactly one provider below. 2921 claims are attributed across 948 distinct sources (941 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 2 | no | 87 | 673 | language, edition, date, finish |
