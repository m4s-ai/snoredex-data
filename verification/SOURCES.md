...
Every sourced claim in this project maps to exactly one provider below. 6269 claims are attributed across 1617 distinct sources (1610 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 136 | 571 | language, identity, finish, edition |
