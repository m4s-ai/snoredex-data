...
Every sourced claim in this project maps to exactly one provider below. 3644 claims are attributed across 1247 distinct sources (1240 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 90 | 132 | language, product |
...
| **Bulbapedia** | fan-wiki | 2 | positive only | 80 | 630 | language, edition, date, finish |
