...
Every sourced claim in this project maps to exactly one provider below. 3535 claims are attributed across 1175 distinct sources (1168 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 27 | 27 | language, product |
