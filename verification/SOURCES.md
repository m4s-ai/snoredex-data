...
Every sourced claim in this project maps to exactly one provider below. 6365 claims are attributed across 1664 distinct sources (1657 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 187 | 699 | language, identity, finish, edition |
