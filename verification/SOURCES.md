...
Every sourced claim in this project maps to exactly one provider below. 2787 claims are attributed across 883 distinct sources (876 unique URLs and 7 non-URL evidence classes).
