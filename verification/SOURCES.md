...
Every sourced claim in this project maps to exactly one provider below. 3565 claims are attributed across 1190 distinct sources (1183 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 70 | 124 | language, identity, finish, edition |
