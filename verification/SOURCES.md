...
Every sourced claim in this project maps to exactly one provider below. 2732 claims are attributed across 867 distinct sources (860 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 3 | no | 75 | 647 | language, edition, date, finish |
