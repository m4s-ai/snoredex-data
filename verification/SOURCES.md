...
Every sourced claim in this project maps to exactly one provider below. 2868 claims are attributed across 921 distinct sources (914 unique URLs and 7 non-URL evidence classes).
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | yes | 28 | 95 | language, finish, product |
