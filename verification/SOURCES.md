...
Every sourced claim in this project maps to exactly one provider below. 6279 claims are attributed across 1619 distinct sources (1612 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 65 | 733 | language, identity, finish, edition |
| **Play! Pokémon rewards gallery** | official-publisher | 1 | positive only | 1 | 32 | finish, product |
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 204 | 735 | language, card-existence, local-set-identifier, rarity, date |
| **Pokémon Card official database (Japan)** | official-publisher | 1 | positive only | 39 | 90 | language, artist, date |
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 104 | 247 | language, product, date |
| **Pokémon official website (Mainland China)** | official-publisher | 1 | positive only | 11 | 48 | language, finish, product |
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | positive only | 144 | 479 | language, finish, product, date |
| **52poke (Wiki)** | collector-database | 2 | positive only | 13 | 34 | language, artist, edition, finish |
| **Bulbapedia** | fan-wiki | 2 | positive only | 89 | 692 | language, edition, date, finish |
| **CGC certification and registry** | grading-registry | 2 | positive only | 0 | 0 | finish, language |
| **Cardmarket exact product image** | marketplace-photo | 2 | positive only | 48 | 217 | language, identity, finish, edition, image |
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | positive only | 8 | 38 | language, identity, finish, edition |
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 196 | language, finish, edition |
| **Elite Fourum** | collector-community | 2 | positive only | 6 | 21 | language, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 136 | 575 | language, identity, finish, edition |
...
| **PokéCardex** | collector-database | 3 | positive only | 2 | 5 | language, identity, finish, product |
| **PokéCottage** | collector-checklist | 3 | positive only | 0 | 0 | language, finish, product, date, artist, rarity |
| **Retailer and specialist card listings** | retail-listing | 3 | positive only | 30 | 97 | finish, product, language, date |
...
| **pokumon.com** | collector-database | 3 | positive only | 10 | 33 | language, finish |
| **Cardmarket** | marketplace-catalogue | 5 | positive only | 348 | 959 | product, image, finish |
...
- **Notes:** The searchable card database is recent and does not cover all older printings. Individually inspected archived card-list rows positively support only the exact cards they show; the archive is not assumed historically complete and omissions remain unknown. Neither surface establishes physical finish.
...
### Malie TCGL reference — <https://malie.io>

- **Organization:** malie.io
- **Terms:** Public TCGL-derived reference data; no separate licence grant inferred. See https://malie.io.
...
- **Notes:** Grouped deliberately: these are one-off listings or retained retailer set-list images, not authoritative catalogues, so per-host provider entries would imply a coverage guarantee none of them offers. An image counts only when it identifies the printing.
