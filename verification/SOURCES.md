...
Every sourced claim in this project maps to exactly one provider below. 6261 claims are attributed across 1632 distinct sources (1625 unique URLs and 7 non-URL evidence classes).
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 181 | language, finish, edition |
