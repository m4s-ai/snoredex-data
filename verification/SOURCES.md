...
Every sourced claim in this project maps to exactly one provider below. 6131 claims are attributed across 1592 distinct sources (1585 unique URLs and 7 non-URL evidence classes).
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 189 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 115 | 495 | language, identity, finish, edition |
