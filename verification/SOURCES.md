...
Every sourced claim in this project maps to exactly one provider below. 6347 claims are attributed across 1654 distinct sources (1647 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 98 | 241 | language, product, date |
