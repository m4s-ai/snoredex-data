...
Every sourced claim in this project maps to exactly one provider below. 6393 claims are attributed across 1651 distinct sources (1644 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 65 | 747 | language, identity, finish, edition |
| **Play! Pokémon rewards gallery** | official-publisher | 1 | positive only | 1 | 32 | finish, product |
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 200 | 727 | language, date |
| **Pokémon Card official database (Japan)** | official-publisher | 1 | positive only | 39 | 90 | language, artist, date |
| **Pokémon Card official database and rules (Korea)** | official-publisher | 1 | positive only | 93 | 236 | language, product |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 183 | 687 | language, identity, finish, edition |
...
| **Retailer and specialist card listings** | retail-listing | 3 | positive only | 29 | 95 | finish, product, language, date |
