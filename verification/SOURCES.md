...
Every sourced claim in this project maps to exactly one provider below. 2902 claims are attributed across 932 distinct sources (925 unique URLs and 7 non-URL evidence classes).
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | yes | 28 | 97 | language, finish, product |
...
| **Cardmarket** | marketplace-catalogue | 5 | no | 396 | 919 | product, image, finish |
