...
Every sourced claim in this project maps to exactly one provider below. 3720 claims are attributed across 1278 distinct sources (1271 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 2 | positive only | 84 | 635 | language, edition, date, finish |
