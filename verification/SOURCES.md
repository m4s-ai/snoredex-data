...
Every sourced claim in this project maps to exactly one provider below. 6143 claims are attributed across 1597 distinct sources (1590 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 120 | 505 | language, identity, finish, edition |
| **TCGdex** | open-database | 2 | positive only | 308 | 739 | language, finish |
