...
Every sourced claim in this project maps to exactly one provider below. 6353 claims are attributed across 1660 distinct sources (1653 unique URLs and 7 non-URL evidence classes).
