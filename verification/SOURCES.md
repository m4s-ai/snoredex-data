...
Every sourced claim in this project maps to exactly one provider below. 6259 claims are attributed across 1617 distinct sources (1610 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 65 | 731 | language, identity, finish, edition |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 191 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 136 | 568 | language, identity, finish, edition |
