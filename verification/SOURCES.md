...
Every sourced claim in this project maps to exactly one provider below. 2879 claims are attributed across 932 distinct sources (925 unique URLs and 7 non-URL evidence classes).
...
| **Cardmarket** | marketplace-catalogue | 5 | no | 396 | 918 | product, image, finish |
