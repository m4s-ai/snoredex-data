...
Every sourced claim in this project maps to exactly one provider below. 3560 claims are attributed across 1187 distinct sources (1180 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 29 | 68 | language, identity, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 69 | 124 | language, identity, finish, edition |
