...
Every sourced claim in this project maps to exactly one provider below. 6197 claims are attributed across 1609 distinct sources (1602 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 132 | 559 | language, identity, finish, edition |
