...
Every sourced claim in this project maps to exactly one provider below. 6106 claims are attributed across 1600 distinct sources (1593 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 62 | 726 | language, identity, finish, edition |
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | positive only | 123 | 430 | language, finish, product |
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 153 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 172 | 634 | language, identity, finish, edition |
