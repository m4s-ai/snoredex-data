...
Every sourced claim in this project maps to exactly one provider below. 3642 claims are attributed across 1246 distinct sources (1239 unique URLs and 7 non-URL evidence classes).
...
| **Collectory** | collector-database | 3 | positive only | 6 | 12 | identity, rarity |
