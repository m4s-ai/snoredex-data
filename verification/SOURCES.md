...
Every sourced claim in this project maps to exactly one provider below. 6281 claims are attributed across 1637 distinct sources (1630 unique URLs and 7 non-URL evidence classes).
...
| **Pokémon Card official database (Asia)** | official-publisher | 1 | positive only | 198 | 722 | language |
| **Pokémon Card official database (Japan)** | official-publisher | 1 | positive only | 39 | 89 | language, artist, date |
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | positive only | 137 | 472 | language, finish, product |
| **52poke (Wiki)** | collector-database | 2 | positive only | 13 | 34 | language, artist, edition, finish |
| **Bulbapedia** | fan-wiki | 2 | positive only | 89 | 647 | language, edition, date, finish |
