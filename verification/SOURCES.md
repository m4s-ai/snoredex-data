...
Every sourced claim in this project maps to exactly one provider below. 2804 claims are attributed across 901 distinct sources (894 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 3 | 15 | language, finish, edition |
...
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | no | 2 | 4 | language, finish, edition |
