...
Every sourced claim in this project maps to exactly one provider below. 3728 claims are attributed across 1282 distinct sources (1275 unique URLs and 7 non-URL evidence classes).
...
| **52poke (Wiki)** | collector-database | 2 | positive only | 4 | 5 | language, artist, edition, finish |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 81 | 138 | language, identity, finish, edition |
...
| **Cardmarket** | marketplace-catalogue | 5 | positive only | 348 | 863 | product, image, finish |
