...
Every sourced claim in this project maps to exactly one provider below. 3560 claims are attributed across 1188 distinct sources (1181 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 69 | 123 | language, identity, finish, edition |
