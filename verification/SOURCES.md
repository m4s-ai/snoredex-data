...
Every sourced claim in this project maps to exactly one provider below. 2789 claims are attributed across 890 distinct sources (883 unique URLs and 7 non-URL evidence classes).
...
| **The Pokémon Company official cards and checklists** | official-publisher | 1 | yes | 5 | 13 | language, finish, product |
