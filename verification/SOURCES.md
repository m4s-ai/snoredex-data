...
Every sourced claim in this project maps to exactly one provider below. 3561 claims are attributed across 1189 distinct sources (1182 unique URLs and 7 non-URL evidence classes).
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 62 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 70 | 123 | language, identity, finish, edition |
