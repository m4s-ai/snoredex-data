...
Every sourced claim in this project maps to exactly one provider below. 6263 claims are attributed across 1615 distinct sources (1608 unique URLs and 7 non-URL evidence classes).
...
| **Collection owner attestation** | non-url-evidence | 2 | positive only | 1 | 194 | language, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 134 | 567 | language, identity, finish, edition |
