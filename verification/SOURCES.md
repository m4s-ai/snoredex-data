...
Every sourced claim in this project maps to exactly one provider below. 2796 claims are attributed across 896 distinct sources (889 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 1 | 9 | language, finish |
...
| **Cardmarket** | marketplace-catalogue | 5 | no | 397 | 933 | product, image, finish |
