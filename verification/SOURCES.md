...
Every sourced claim in this project maps to exactly one provider below. 3048 claims are attributed across 921 distinct sources (914 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | no | 5 | 17 | language, finish, edition |
...
| **Cardmarket seller listing photograph** | marketplace-photo | 2 | no | 4 | 5 | language, finish, edition |
