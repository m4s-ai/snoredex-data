...
Every sourced claim in this project maps to exactly one provider below. 2791 claims are attributed across 883 distinct sources (876 unique URLs and 7 non-URL evidence classes).
...
| **Retailer and specialist card listings** | retail-listing | 3 | no | 6 | 33 | finish, product, language |
