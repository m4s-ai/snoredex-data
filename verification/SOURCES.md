...
Every sourced claim in this project maps to exactly one provider below. 3689 claims are attributed across 1267 distinct sources (1260 unique URLs and 7 non-URL evidence classes).
...
| **Bulbapedia** | fan-wiki | 2 | positive only | 84 | 636 | language, edition, date, finish |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 74 | 131 | language, identity, finish, edition |
...
| **Collectory** | collector-database | 3 | positive only | 15 | 22 | identity, rarity |
...
| **pokumon.com** | collector-database | 3 | positive only | 9 | 13 | language, finish |
