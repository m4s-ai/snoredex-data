...
Every sourced claim in this project maps to exactly one provider below. 6269 claims are attributed across 1633 distinct sources (1626 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 65 | 749 | language, identity, finish, edition |
