...
Every sourced claim in this project maps to exactly one provider below. 2901 claims are attributed across 932 distinct sources (925 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | no | 8 | 8 | language, finish, edition |
