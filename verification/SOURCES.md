...
Every sourced claim in this project maps to exactly one provider below. 2919 claims are attributed across 947 distinct sources (940 unique URLs and 7 non-URL evidence classes).
...
| **Seller listing photograph** | marketplace-photo | 2 | no | 20 | 21 | language, identity, finish, edition |
