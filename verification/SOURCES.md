...
Every sourced claim in this project maps to exactly one provider below. 3562 claims are attributed across 1186 distinct sources (1179 unique URLs and 7 non-URL evidence classes).
...
|---|---|---:|:---:|---:|---:|---|
| **Inspected physical specimen** | non-url-evidence | 1 | positive only | 29 | 76 | language, identity, finish, edition |
...
| **Seller listing photograph** | marketplace-photo | 2 | positive only | 68 | 118 | language, identity, finish, edition |
