...
requiring transfer from the Japanese number. The Holo finish for these eleven rendered releases is established directly
by their card faces.
...
The owner clarifies that AC3b 238/204 is its own Indonesian release and that its artwork is from Japanese SM9.
