...
- `CLAUDE.md` nennt neun ausschließlich auf inspizierten Specimens beruhende Einheiten. Im aktuellen Store gibt es insgesamt acht Einheiten mit `providerId=inspected-specimen`, fünf davon ohne Korroboration. Dieser konkrete Begleitwert ist veraltet. Die Zahl 19 für reine Eigentümerattestation wurde dagegen überprüft und passt weiterhin.
