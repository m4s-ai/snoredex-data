...
Current-known status snapshot: **2026-09-09**. Its candidate denominator is the immutable legacy baseline `cardmarket-search-2026-07-21`; these totals do not claim all-locality discovery completeness.
...
| Evidence-safe application status | **617 established**, **11 needs evidence**, **87 owner-adjudicated not printed**, and **4 disputed**. Raw verdicts and observations stay queryable; unsupported confirmation does not mint a printing. |
| Current-known physical checklist | **889 items** across 174 cards and 15 languages: 814 documented printings plus 75 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 472 externally confirmed, 50 marketplace-only positives, 39 without positive finish evidence, and 76 not applicable. The remaining detail/mapping queue contains 143 units. |
| Evidence registry | **32 providers**, 1282 evidence records, 1275 unique URLs, and 3,728 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
