...
| Evidence registry | **32 providers**, 1600 evidence records, 1593 unique URLs, and 6,106 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
