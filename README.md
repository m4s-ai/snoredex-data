...
| Evidence registry | **32 providers**, 1609 evidence records, 1602 unique URLs, and 6,197 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
