...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-822_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **822 items** across 174 cards and 15 languages: 680 documented printings plus 142 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 370 externally confirmed, 83 marketplace-only positives, 109 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 205 units. |
| Evidence registry | **26 providers**, 1028 evidence records, 1021 unique URLs, and 3,187 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
