...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-864_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **864 items** across 174 cards and 15 languages: 727 documented printings plus 137 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 376 externally confirmed, 79 marketplace-only positives, 107 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 234 units. |
| Evidence registry | **26 providers**, 1044 evidence records, 1037 unique URLs, and 3,267 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
