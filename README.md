...
| Current-known finish evidence | **637 card-number × language units**: 369 externally confirmed, 84 marketplace-only positives, 109 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 205 units. |
| Evidence registry | **26 providers**, 1027 evidence records, 1020 unique URLs, and 3,185 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
