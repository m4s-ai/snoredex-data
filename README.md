...
| Current-known physical checklist | **867 items** across 174 cards and 15 languages: 763 documented printings plus 104 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 423 externally confirmed, 65 marketplace-only positives, 74 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 201 units. |
| Evidence registry | **30 providers**, 1091 evidence records, 1084 unique URLs, and 3,386 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
