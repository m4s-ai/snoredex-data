...
| Current-known physical checklist | **898 items** across 174 cards and 15 languages: 827 documented printings plus 71 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 481 externally confirmed, 45 marketplace-only positives, 35 without positive finish evidence, and 76 not applicable. The remaining detail/mapping queue contains 139 units. |
| Evidence registry | **32 providers**, 1592 evidence records, 1585 unique URLs, and 6,131 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
