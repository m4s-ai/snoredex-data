...
| Evidence registry | **33 providers**, 1615 evidence records, 1608 unique URLs, and 6,263 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
