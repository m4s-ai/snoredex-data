...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-899_items-2563eb)](analysis_checklist.json)
...
| A bounded Malie interchange pilot | [Bundle and standalone-reader instructions](exports/malie/README.md) | Three real printings in two languages; all six selected inputs are accounted for. Keep cards, report and profile together to preserve printing IDs, evidence and gaps. |
...
Current-known status snapshot: **2026-09-24**. Its candidate denominator is the immutable legacy baseline `cardmarket-search-2026-07-21`; these totals do not claim all-locality discovery completeness.
...
| Current-known physical checklist | **899 items** across 174 cards and 15 languages: 831 documented printings plus 68 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 486 externally confirmed, 43 marketplace-only positives, 32 without positive finish evidence, and 76 not applicable. The remaining detail/mapping queue contains 136 units. |
| Evidence registry | **33 providers**, 1617 evidence records, 1610 unique URLs, and 6,269 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
...
| 2 | 52poke (Wiki) · Bulbapedia · CGC certification and registry · Cardmarket exact product image · Cardmarket seller listing photograph · Collection owner attestation · Elite Fourum · Malie TCGL reference · PSA certification and registry · SNKRDUNK · Seller listing photograph · TCGdex · pokemontcg.io |
