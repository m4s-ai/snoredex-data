...
| Evidence registry | **32 providers**, 1610 evidence records, 1603 unique URLs, and 6,199 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
