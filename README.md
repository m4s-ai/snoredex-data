...
| Evidence registry | **32 providers**, 1591 evidence records, 1584 unique URLs, and 6,261 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
