...
| Evidence registry | **32 providers**, 1283 evidence records, 1276 unique URLs, and 3,729 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
