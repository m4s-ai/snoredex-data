...
| Evidence registry | **32 providers**, 1534 evidence records, 1527 unique URLs, and 5,064 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
