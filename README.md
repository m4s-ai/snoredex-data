...
| Current-known physical checklist | **899 items** across 174 cards and 15 languages: 829 documented printings plus 70 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 483 externally confirmed, 44 marketplace-only positives, 34 without positive finish evidence, and 76 not applicable. The remaining detail/mapping queue contains 138 units. |
| Evidence registry | **32 providers**, 1603 evidence records, 1596 unique URLs, and 6,173 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
