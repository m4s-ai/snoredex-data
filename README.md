...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-863_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **863 items** across 174 cards and 15 languages: 726 documented printings plus 137 explicit unresolved placeholders. |
...
| Evidence registry | **26 providers**, 1043 evidence records, 1036 unique URLs, and 3,262 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
