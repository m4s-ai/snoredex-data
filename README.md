...
| Evidence registry | **33 providers**, 1614 evidence records, 1607 unique URLs, and 6,252 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
