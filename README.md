...
| Current-known finish evidence | **637 card-number × language units**: 361 externally confirmed, 92 marketplace-only positives, 109 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 205 units. |
| Evidence registry | **26 providers**, 933 evidence records, 926 unique URLs, and 2,904 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
