...
| Evidence registry | **32 providers**, 1474 evidence records, 1467 unique URLs, and 4,645 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
