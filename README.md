...
| Evidence registry | **33 providers**, 1619 evidence records, 1612 unique URLs, and 6,276 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
