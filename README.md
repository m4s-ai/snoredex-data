...
| Evidence registry | **32 providers**, 1660 evidence records, 1653 unique URLs, and 6,353 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
