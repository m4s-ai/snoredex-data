...
| Evidence registry | **32 providers**, 1606 evidence records, 1599 unique URLs, and 6,187 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
