...
| Current-known physical checklist | **852 items** across 174 cards and 15 languages: 717 documented printings plus 135 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 378 externally confirmed, 79 marketplace-only positives, 105 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 232 units. |
| Evidence registry | **26 providers**, 1047 evidence records, 1040 unique URLs, and 3,243 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
