...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-832_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **832 items** across 174 cards and 15 languages: 695 documented printings plus 137 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 372 externally confirmed, 83 marketplace-only positives, 107 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 203 units. |
| Evidence registry | **26 providers**, 949 evidence records, 942 unique URLs, and 2,926 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
