...
| Evidence registry | **32 providers**, 1622 evidence records, 1615 unique URLs, and 6,172 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
