...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-867_items-2563eb)](analysis_checklist.json)
...
Current-known status snapshot: **2026-08-27**. Its candidate denominator is the immutable legacy baseline `cardmarket-search-2026-07-21`; these totals do not claim all-locality discovery completeness.
...
| Current-known physical checklist | **867 items** across 174 cards and 15 languages: 761 documented printings plus 106 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 421 externally confirmed, 65 marketplace-only positives, 76 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 203 units. |
| Evidence registry | **30 providers**, 1084 evidence records, 1077 unique URLs, and 3,374 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
...
| 3 | LigaPokemon · Limitless TCG · PKParaiso · PokéCardex · PokéCottage · Retailer and specialist card listings · TCGCSV (TCGplayer product data) · WikiDex · koreanpokemoncards.com · pokumon.com |
...
|---|---:|
| Corroborated by a second provider | 70 |
| Single tier 1-2 source | 646 |
| Single tier 3 source | 3 |

649 of 719 resolved claims rest on one provider. Check `E3` does not forbid that: it requires an uncorroborated claim to be **checkable or strong**, so a tier-3 page anyone can open may carry one alone, and 3 do. What it forbids is a claim that is neither — all 20 claims with no URL come from tier 1 or 2, where the evidence is the owner's own cards.
