...
| Evidence registry | **32 providers**, 1637 evidence records, 1630 unique URLs, and 6,281 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
