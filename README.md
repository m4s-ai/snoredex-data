...
| Current-known finish evidence | **637 card-number × language units**: 377 externally confirmed, 78 marketplace-only positives, 107 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 234 units. |
| Evidence registry | **26 providers**, 1045 evidence records, 1038 unique URLs, and 3,241 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
