...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-872_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **872 items** across 174 cards and 15 languages: 785 documented printings plus 87 explicit unresolved placeholders. |
...
| Evidence registry | **30 providers**, 1142 evidence records, 1135 unique URLs, and 3,477 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
