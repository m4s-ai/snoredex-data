...
| Evidence registry | **32 providers**, 1267 evidence records, 1260 unique URLs, and 3,689 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
