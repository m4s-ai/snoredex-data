...
| Evidence registry | **32 providers**, 1249 evidence records, 1242 unique URLs, and 3,648 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
