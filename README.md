...
| Current-known physical checklist | **831 items** across 174 cards and 15 languages: 694 documented printings plus 137 explicit unresolved placeholders. |
...
| Evidence registry | **26 providers**, 947 evidence records, 940 unique URLs, and 2,919 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
