...
| Evidence registry | **32 providers**, 1278 evidence records, 1271 unique URLs, and 3,721 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
