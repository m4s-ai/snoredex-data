...
| Evidence registry | **32 providers**, 1279 evidence records, 1272 unique URLs, and 3,723 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
