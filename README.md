...
| Evidence registry | **32 providers**, 1654 evidence records, 1647 unique URLs, and 6,347 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
