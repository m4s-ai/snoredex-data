...
| Current-known physical checklist | **890 items** across 174 cards and 15 languages: 814 documented printings plus 76 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 472 externally confirmed, 50 marketplace-only positives, 40 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 144 units. |
