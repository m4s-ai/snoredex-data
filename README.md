...
| Current-known finish evidence | **637 card-number × language units**: 370 externally confirmed, 83 marketplace-only positives, 109 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 206 units. |
