...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-891_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **891 items** across 174 cards and 15 languages: 816 documented printings plus 75 explicit unresolved placeholders. |
...
| Evidence registry | **32 providers**, 1629 evidence records, 1622 unique URLs, and 6,202 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
