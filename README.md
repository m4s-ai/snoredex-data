...
| Current-known finish evidence | **637 card-number × language units**: 382 externally confirmed, 77 marketplace-only positives, 103 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 230 units. |
| Evidence registry | **26 providers**, 1053 evidence records, 1046 unique URLs, and 3,250 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
