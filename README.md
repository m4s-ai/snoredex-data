...
| Evidence registry | **33 providers**, 1617 evidence records, 1610 unique URLs, and 6,259 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
