...
| The supported collector entry point | [`collector_catalogue.json`](collector_catalogue.json) | Locality-aware stable IDs, verified printings, finish candidates and research placeholders, including source-first releases without legacy predecessors. |
| Legacy checklist and tracker compatibility | [`analysis_checklist.json`](analysis_checklist.json) | Stable predecessor IDs; only verified printings count as current-known. Candidates and placeholders remain research. |
...
| Legacy compatibility checklist | **889 items** across 174 cards and 15 languages: 701 verified printings, 112 finish candidates and 76 explicit unresolved placeholders. |
...
| [`analysis_checklist.json`](analysis_checklist.json) | Legacy compatibility checklist with explicit collector states and graph evidence references. |
