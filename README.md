...
[![Current-known checklist](https://img.shields.io/badge/current--known_checklist-873_items-2563eb)](analysis_checklist.json)
...
| Current-known physical checklist | **873 items** across 174 cards and 15 languages: 785 documented printings plus 88 explicit unresolved placeholders. |
| Current-known finish evidence | **637 card-number × language units**: 446 externally confirmed, 58 marketplace-only positives, 58 without positive finish evidence, and 75 not applicable. The remaining detail/mapping queue contains 185 units. |
| Evidence registry | **30 providers**, 1091 evidence records, 1084 unique URLs, and 3,409 attributed claims. Bounded source scopes provide absence rationale; the separate owner-adjudication store records final language/printing absence decisions. |
