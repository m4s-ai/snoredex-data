...
| Evidence registry | **32 providers**, 1633 evidence records, 1626 unique URLs, and 6,266 attributed claims. Every external provider is positive only. The separate owner-adjudication store records final language and printing absence decisions. |
